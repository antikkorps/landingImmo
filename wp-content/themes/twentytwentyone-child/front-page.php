        ...
        <div class="row section_audio mx-5 my-5 justify-content-center">
            ...
            <div class="col-sm-12 col-md-auto col-lg-4">
                <div class="card">
                    ...
                    <div class="card-footer text-center">
                        <a href="" class="btn btn-primary mx-auto my-2">Développez votre potentiel</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-auto col-lg-4">
                <div class="card">
                    ...
                    <div class="card-footer text-center">
                        <a href="" class="btn btn-primary mx-auto my-2">Cliquez ici pour vous mettre à jour</a>
                    </div>
                </div>
            </div>
...
<div class="titre_section d-flex justify-content-center my-5" id="avantages">
    <h3>NOS AVANTAGES</h3>
</div>
...
<div class="container" id='deroulement_des_formations'>
    <div class="title_section d-flex justify-content-center my-5">
        <h3>LE DEROULEMENT DE NOS FORMATIONS</h3>
    </div>
    <p class="my-5 presentation">Elles ont été pensées pour vous permettre de les réaliser en distanciel. Pas besoin de se déplacer et donc un gain substanciel de temps. Elles vous permettront de gagner rapidement en efficacité sur les sujets qui vous intéressent</p>
...
<div class="titre_section d-flex justify-content-center my-5">
...
<div class="container_logo my-5">
    ...
    <!-- container -->
    <a class="btn btn-primary btn-lg d-flex justify-content-center mx-auto my-5 col-sm-6 col-md-5 col-lg-2" href="">En savoir plus</a>
</div>
...
<div class="container my-5 mx-auto d-flex justify-content-center">
    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card">
                <img src=<?php echo wp_get_upload_dir()['baseurl'] . '/2023/05/avi-werde-hHz4yrvxwlA-unsplash-scaled.jpg';  ?> class="card-img-top" alt="illustration carte">
                <div class="card-body">
...
<!-- CALL TO ACTION -->
<div class="d-grid gap-2 col-sm-6 col-md-5 col-lg-2 mx-auto my-5">
    <a href="#" class="btn btn-primary btn-lg">Contactez-nous pour tester</a>
</div>

<!-- CONTACT CONTAINER -->
<div class="contact_container d-flex justify-content-center mx-auto my-5" id="contact_container">

    <div class="form-content col-sm-12 col-md-6 col-lg-6 mx-4">
        <h4 class="text-center">Contactez-nous ici</h4>
        <?php echo do_shortcode('[wpforms id="36"]'); ?>
    </div>
    <img class='col-sm-12 col-md-6 col-lg-4 rounded-end' src="<?php echo wp_get_upload_dir()['baseurl'] . '/2023/05/kam-idris-kyt0PkBSCNQ-unsplash-scaled.jpg';  ?>" alt="">
</div>

<!-- BACK TO TOP -->
<a href="#" class="backtotop d-flex justify-content-center align-items-center rounded-circle">top<i class="fas fa-arrow-up"></i></a>
